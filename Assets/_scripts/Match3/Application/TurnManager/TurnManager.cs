...
namespace Lighthouse.Match3.Application.TurnManager
{
    ...
    public class TurnManager
    {
        ...
        private readonly Lighthouse.Match3.Domain.Spawner.ISpawner spawner;
        ...
        public TurnManager(
            ...
            IGravity gravity,
            Lighthouse.Match3.Domain.Spawner.ISpawner spawner)
        {
